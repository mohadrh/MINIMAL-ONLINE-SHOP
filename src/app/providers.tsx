...
export function Providers({ children }: { children: React.ReactNode }) {
  ...
  /* افزودن، سبد را باز *نمی‌کند*.

     یک بار باز می‌کرد و منطقش این بود که کاربر بازخورد لازم دارد.
     ولی کسی که دارد چند محصول را کنار هم می‌بیند، با هر افزودن از
     صفحه بیرون انداخته می‌شد و باید کشویی را می‌بست تا ادامه
     بدهد — یعنی همان کاری که آمده بود بکند، سخت‌تر می‌شد.

     بازخورد سر جایش هست: شمارنده‌ی روی آیکون می‌پرد و نامِ افزوده
     نگه داشته می‌شود، پس هر وقت خودش سبد را باز کند همان پیام را
     می‌بیند. */
