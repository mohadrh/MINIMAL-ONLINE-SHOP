...
/** کانالِ پشتیبانی در تلگرام.

    ⚠ همان دسته‌ی کانالِ خبر است و باید با آیدیِ واقعیِ پشتیبانی
    عوض شود. تا آن روز کاربر به همین‌جا می‌رسد که دستِ‌کم آدمی
    پشتش هست. */
export const SUPPORT_TELEGRAM = 'Ph0enix_Shop';
