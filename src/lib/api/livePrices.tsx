...
export interface LivePrice {
  ...
  /**
   * مبلغِ دلاری، اگر پلن دلاری باشد.
   *
   * ⚠ بدون این، تغییرِ مبلغِ دلاری در پنل تا بیلدِ بعدی دیده
   * نمی‌شد: تومانِ پلن‌های دلاری از نرخِ روز حساب می‌شود نه از
   * ووکامرس، پس عددِ ‎price‎ی که سرور می‌فرستد برایشان بی‌اثر
   * است و فقط همین فیلد می‌تواند خبر بدهد.
   */
  usd?: number | null;
  stock: number | null;
}
