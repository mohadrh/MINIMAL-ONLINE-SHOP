...
export const HERO_SLIDES: HeroSlideData[] = [
  {
    ...
    art: {
      ...
      tiles: [
        ...
        { id: 'claude', bg: '#ffffff', logo: 'claude-mark.svg' },
  ...
  },
  {
    id: 'social-spotify',
    kind: 'social',
    kindLabel: 'شبکه‌های اجتماعی',
    titleLead: 'اسپاتیفای',
    titleAccent: 'پریمیوم',
    englishTitle: 'Spotify Premium',
    kicker: 'بدون آگهی، با دانلود آفلاین',
    description:
      'همان حساب همیشگی‌ات پریمیوم می‌شود؛ پلی‌لیست‌ها و تاریخچه‌ات سر جایشان می‌مانند. تلگرام پریمیوم هم در همین دسته است.',
    highlights: [
    ...
    art: {
      ...
      tiles: [
        { id: 'spotify', bg: '#ffffff', logo: 'spotify.png' },
        { id: 'youtube', bg: '#ffffff', logo: 'youtube.png' },
        { id: 'telegram', bg: '#229ed9' },
        { id: 'discord', bg: '#ffffff', logo: 'discord.png' },
      ],
    },
    platforms: ['Web', 'iOS', 'Android'],
  },
