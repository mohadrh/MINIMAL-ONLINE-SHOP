...
const SUBSCRIPTIONS: Product[] = [
  ...
  },
  {
    ...
    warrantyLabel: 'گارانتی تمام دوره‌ی اشتراک',
    /* ⚠ قیمت‌ها هنوز تأیید نشده‌اند.

       مبلغِ دلاریِ پلن‌ها از صفحه‌ی رسمیِ خودِ هیگزفیلد است، ولی
       حاشیه‌ی فروشِ ما رویشان اعمال نشده. تا وقتی کارفرما عدد
       بدهد، تومانش از همان نرخِ کاتالوگ حساب می‌شود — یعنی
       ممکن است با قیمتِ نهایی فرق کند. */
    variants: [
      { id: 'higgsfield-basic-1m', label: 'Basic — یک ماهه', price: 0, usd: 9, stock: null, isDefault: true,
        guide: { fit: 'برای امتحان کردن و ویدیوهای کوتاه.', detail: 'اعتبارِ ماهانه‌ی پایه، کافی برای چند کلیپِ کوتاه و آشنا شدن با حرکت‌های دوربین.' } },
      { id: 'higgsfield-pro-1m', label: 'Pro — یک ماهه', price: 0, usd: 29, stock: null,
        guide: { fit: 'برای تولیدکننده‌ی محتوایی که هفتگی کار می‌دهد.', detail: 'اعتبارِ بیشتر، صفِ سریع‌تر، و دسترسی به حالت‌هایی که در پلن پایه قفل‌اند.' } },
      { id: 'higgsfield-ultimate-1m', label: 'Ultimate — یک ماهه', price: 0, usd: 49, stock: null,
        guide: { fit: 'برای کارِ حرفه‌ای و پروژه‌ی سنگین.', detail: 'بیشترین اعتبار و بالاترین اولویت در صف. مالِ کسی است که ویدیو کارِ روزانه‌اش است.' } },
    ],
