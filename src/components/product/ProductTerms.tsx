  ...
  return (
    ...
    <section className="pterms">
      ...
      <ul className="pterms__quick">
        ...
        {/* ⚠ این‌جا «رمز عبورت — هیچ‌وقت لازم نمی‌شود» بود.

            کارفرما گفت گفتنش لازم نیست چون معلوم است. و جای خالی‌اش
            بهتر پر می‌شود: از سه نکته‌ی همیشه‌پیدا، دوتایش چیزی بود
            که مشتری *می‌دهد*؛ سومی حالا چیزی است که *می‌گیرد*. */}
        <li>
