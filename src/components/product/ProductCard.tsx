...
/* ⚠ دکمه‌ی افزودن دیگر رنگین‌کمان نیست.

   هر کارت یکی از هفت توقفِ کمانِ ققنوس را برمی‌داشت و دکمه‌ی
   افزودنش همان را پاستلی می‌کرد، پس ردیفِ کارت‌ها رنگین‌کمان
   می‌شد. در پالتِ بنفشِ قبلی این جواب می‌داد چون همه‌ی آن هفت
   رنگ خویشاوندِ بنفش بودند.

   در پالتِ تراکوتا نه: سرخابی و بنفشِ کمان کنارِ تراکوتا بیگانه
   می‌نشینند، و ماکاپِ کارفرما هم هر دکمه‌ای را تخت و به رنگِ
   برند می‌گذارد — هیچ گرادیانتِ رنگین‌کمانی در آن نیست.

   ⚠ فقط رنگ عوض شد، نه شکل. همان شیشه، همان هاله، همان هاور؛
   حالا فقط همه یک رنگ‌اند. */
