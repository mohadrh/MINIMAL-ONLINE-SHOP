    ...
    <header className="nav">
      ...
      <div className="wrap nav__inner">
        ...
        <nav className="nav__links" aria-label="محصولات">
          ...
          {/* ⚠ «شماره مجازی» این‌جا نیست چون در مگامنو هست.

              دو راه به یک صفحه، در یک نوار، فقط جا می‌گیرد —
              و کاربر فکر می‌کند دوتا چیزِ متفاوت‌اند. مگامنو
              جای بهتری است چون آن‌جا کشورها را هم نشان
              می‌دهد. */}
        ...
        <div className="nav__actions">
          ...
          {/* سبد، کشویی را باز می‌کند نه صفحه‌ی سبد را.
              ...
              هنوز <a> است تا با کلیک وسط یا Ctrl در تب تازه باز
              شود و آدرسش هم قابل کپی بماند؛ کلیک ساده را می‌گیریم
              و به‌جایش کشویی می‌آید.

              ⚠ ولی چون <a> خام است نه <Link>، خودش basePath
              نمی‌گیرد. روی سایت زنده که زیرمسیر دارد، /cart به
              ریشه‌ی دامنه می‌رفت و صفحه‌ی ناموجود می‌شد — فقط با
              کلیک وسط دیده می‌شد، برای همین تا حالا از چشم افتاده
              بود. */}
          <a
            ref={cartRef}
            href={asset('/cart')}
