...
export function ContactView() {
  ...
  return (
    <>
      ...
      {/* ---------- امنیت و اطلاعات ثبتی ---------- */}
      <section className="section">
        <div className="wrap ctc__notes">
          <article className="ctc__note ctc__note--warn">
            <span className="ctc__note-ico" aria-hidden="true"><ShieldCheck /></span>
            <div>
              <h2>چه چیزی هیچ‌وقت از تو نمی‌پرسیم</h2>
              <p>
                رمز عبور حساب‌هایت، رمز دوم کارت بانکی، و کد پیامکیِ بانک. هیچ‌کدام
                برای هیچ سفارشی لازم نیست. اگر کسی به اسم فونیکس شاپ این‌ها را خواست،
                از طرف ما نیست — همان‌جا قطع کن و به ما خبر بده.
              </p>
            </div>
          </article>
