...
const EXTRAS: { icon: React.ComponentType<{ className?: string }>; title: string; href: string; tube: string }[] = [
  ...
  /* ⚠ رنگ‌ها از توکن می‌آیند، نه شش hex دلخواه.
     ...
     پیگیری و راهنما آبی. */
  /* ⚠ هر چهار رنگِ تم، و هیچ دو همسایه‌ای هم‌رنگ نیستند.

     قبلاً سه‌تا از شش‌تا آبی بودند و ردیف یکنواخت می‌شد. حالا
     ترتیب طوری است که کنارِ هم هیچ رنگی تکرار نمی‌شود — پس
     ردیف متنوع دیده می‌شود بی‌آنکه رنگی از بیرونِ پالت بیاید.

     انتخابِ هر رنگ هم دلیل دارد، نه گردش:
       مقایسه و پیگیری → آبیِ اعتماد (کارهای ابزاری و مطمئن)
       باشگاه         → کهربایی (همان رنگِ باشگاه در کلِ سایت)
       پرفروش و نمایندگی → تراکوتای برند (فروش و همکاری)
       راهنما         → بنفشِ هوش مصنوعی (خواندن و یادگرفتن) */
