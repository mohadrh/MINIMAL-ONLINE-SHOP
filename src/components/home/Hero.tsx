...
export function Hero() {
  ...
  return (
    <section className="hero">
      ...
      {/* ⚠ جعبه‌ی جست‌وجوی زیرِ اسلایدها برداشته شد.

          استدلالش این بود که کاربرِ تازه‌رسیده نباید برای نوشتنِ
          نامِ چیزی اسکرول کند. ولی جست‌وجو همین حالا در نوارِ
          بالا هست و همیشه هم هست — این یکی تکرارش بود، درست زیرِ
          هیرو، و اولین چیزی که بعد از اسلاید دیده می‌شد یک کادرِ
          خالیِ دیگر بود به‌جای محصولات. */}
    </section>
  );
}
