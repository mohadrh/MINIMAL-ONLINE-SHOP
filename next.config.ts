  ...
  ...(isStatic
    ? {
        ...
        /* ⚠ distDir را عوض نکن.
           ...
           یک بار روی ‎.next-static‎ گذاشته شد تا بیلدِ هاست کشِ
           سرورِ توسعه را پاک نکند. ولی وقتی ‎output: 'export'‎
           باشد، نکست خروجیِ نهایی را هم داخلِ همان distDir
           می‌ریزد نه در ‎out/‎ — و اسکریپتِ هاست پوشه‌ای را
           می‌ساخت که هیچ‌وقت پیدا نمی‌شد. */
